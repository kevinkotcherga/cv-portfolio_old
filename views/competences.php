...
<body class="body">
  ...
  <?php include("../php/header.php"); ?>
    ...
    <section class="section-competences">
      <h1>Compétences</h1>
        <h2>J'ai acquéri des notions dans :</h2>
          <div class="section-competences__bloc-competences">
            <p><img class="html5" src="../images/html-black.png" alt="">Html 5</p>
            <p><img class="bootstrap"  src="../images/bootstrap.png" alt="">Bootstrap</p>
